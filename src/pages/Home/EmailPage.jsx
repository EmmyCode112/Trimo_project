        ...
        <div className="max-w-[1214px] mx-auto px-4 flex flex-col md:flex-row items-center gap-8 md:gap-[106px]">
          ...
          <div className="w-full md:w-[596px] space-y-9 fade-up">
            ...
            <p className="text-gray-700 text-lg max-w-lg">
              Create, send, and track engaging email campaigns that drive results. 
              Perfect for newsletters, promotions, and customer communications.
            </p>
            <div>
              <Link 
                to="/get-started" 
      ...
      <section className="py-20">
        <div className="max-w-[1216px] mx-auto px-4">
          <div className="text-center mb-16 fade-up">
            ...
            <h2 className="text-3xl text-[#1A1A1A] md:text-4xl font-semibold">Email Marketing Features</h2>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-[73px]">
              ...
              <div className="space-y-2 max-w-[330px]">
                <div className="flex items-center gap-2">
                  <h3 className="font-semibold text-[#484848] text-xl">Analytics Dashboard</h3>
                </div>
              ...
              <div className="space-y-2 max-w-[330px]">
                <div className="flex items-center gap-2">
                  <h3 className="font-semibold text-[#484848] text-xl">GDPR Compliant</h3>
                </div>
                <p className="text-[#484848] font-medium text-lg">
              ...
              <div className="space-y-2 max-w-[330px]">
                <div className="flex items-center gap-2">
                  <h3 className="font-semibold text-[#484848] text-xl">Easy Integration</h3>
                </div>
