...
const HeroSection = () => {
  ...
  return (
    <div
      ref={heroRef}
      className="flex flex-col  gap-[30px] md:gap-[60px] px-[0] md:px-[37px] lg:px-[85px] mt-[100px] pt-[40px] md:pt-[62px] lg:pt-[112px] lg:rounded-[20px] hero-section relative max-md:mx-0 mx-[65px]"
    >
      <div className="absolute w-full h-full left-0 top-0 z-[-1] bg-[#ebebf0c4] lg:rounded-[20px]"></div>
      <div className="text-center">
        <p
          ref={badgeRef}
          className="bg-[#EBEBF099] rounded-full py-2 px-[10px] text-[#484848] text-[14px] font-normal w-[270px] mx-auto flex justify-center"
        >
          No Credit Card Needed for Sign up
        </p>
        <h2
          ref={titleRef}
          className="text-[30px] lg:text-[48px] max-sm:text-[28px] font-bold mt-4  w-full md:w-[80%] lg:w-[70%] leading-[60px] mx-auto"
        >
          <span className="text-[#1A1A1A]">Effortless</span>{" "}
          ...
          <span className="text-[#1A1A1A]">for your Business</span>
        </h2>
        <h6
          ref={subtitleRef}
          className="text-[#484848] w-full sm:w-[80%] md:w-[70%] lg:w-[38%] mt-4 text-[18px] font-medium leading-[28px] mx-auto"
        >
        ...
        <div
          ref={buttonsRef}
          className="flex items-center mt-[27px] gap-3 mx-auto text-center justify-center"
        >
          <Button
