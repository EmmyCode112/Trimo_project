...
const UseCases = () => {
  ...
  return (
    <div>
      <div
        ref={heroRef}
        className="w-full flex flex-col gap-[14px] items-center justify-center bg-gradient-to-r from-[#CB1E33] via-[#9A2444] to-[#383268] h-[504px] text-center mt-[100px] overflow-hidden "
      >
        <h2
          ref={titleRef}
          className="text-white font-semibold text-[48px] leading-[60px] lg:max-w-[60%]"
        >
          Discover How TRIIMO Powers Your Communications
        </h2>
        <p
          ref={subtitleRef}
          className="text-[18px] font-medium text-white lg:max-w-[50%]"
        >
          Explore real-world examples of how TRIIMO helps teams and businesses
          streamline messaging across multiple channels.
        </p>
      </div>
      <div className="flex flex-col py-[60px] gap-[47px] overflow-hidden">
        <div
          data-aos="fade-left"
          data-aos-duration="500"
          className="pl-[105px] flex items-center gap-[96px]"
        >
          <div className="flex flex-col gap-8 lg:basis-[45%]">
            <div className="flex flex-col gap-6">
              ...
              <h1
                ...
                data-aos-duration="500"
                data-aos-delay="50"
                className="text-[#3F3E3E] text-[24px] font-semibold"
              >
              ...
              <p
                ...
                data-aos-duration="500"
                data-aos-delay="100"
                className="text-[#767676] text-[18px] font-normal"
              >
        ...
        <div
          ...
          data-aos-duration="500"
          data-aos-delay="120"
          className="pr-[105px] flex items-center gap-[96px]"
        >
          <div className="lg:basis-[45%]">
            <img
