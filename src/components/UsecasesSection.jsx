      ...
      <div className="max-w-content mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <Link 
              to="/marketing-teams" 
              className="inline-flex items-center border border-triimo-border rounded-lg px-5 py-2 text-sm font-medium transition-colors hover:bg-gray-100"
            >
              See More
            </Link>
          </div>
          ...
          <div 
            ...
            className="fade-up bg-gray-50 rounded-xl p-8 hover:shadow-md transition-shadow"
          >
            <h3 className="text-xl font-semibold mb-4">Customer Support Teams</h3>
            <p className="text-gray-700 mb-8">
