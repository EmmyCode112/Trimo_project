    ...
    <section ref={sectionRef} className="py-24 px-4 max-w-[1440px] mx-auto fade-up" id="how-it-works">
      <div className="text-center mb-12">
        <div className="inline-block rounded-[37px] bg-[#EBEBF099] py-[7px] px-[10px] mb-4">
          <span className="text-[#484848] font-general font-medium text-[14px] leading-[20px]">Step-by-Step</span>
        </div>
        <h2 className="text-[40px] font-general font-semibold leading-tight mb-8">
          How Triimo Works
        </h2>
        <p className="text-[18px] font-general font-medium text-gray-600 max-w-[750px] mx-auto">
      ...
      >
        <div className="w-full md:w-[415px] h-auto md:h-[340px] relative">
          <div className="w-full h-full rounded-[10px] border border-[#F1F1F1] bg-[#FAFAFA] overflow-hidden relative">
            <div 
              className="absolute border-2 border-[#383268] rounded-[10px] overflow-hidden"
              style={{ 
                width: '433px',
            ...
            >
              <img 
                src="/lovable-uploads/30d7931e-fee2-4af6-9b7c-c034b361bcd0.png" 
        ...
        <div className="flex-1">
          <h3 className="text-[30px] font-general font-semibold leading-tight mb-6">
            Sign up and choose your messaging needs
          </h3>
          <ul className="space-y-4 list-none">
            <li className="flex items-start gap-2">
              <span className="inline-block w-1.5 h-1.5 rounded-full bg-triimo-red mt-3"></span>
              <p className="text-[18px] font-general font-medium text-gray-600">
          ...
          <div className="mt-8">
            <Button className="bg-white text-triimo-purple border border-triimo-border hover:bg-gray-50">
              Sign Up for Free
            </Button>
          </div>
        </div>
      ...
      >
        ...
        <div className="w-full md:w-[415px] h-auto md:h-[340px] relative">
          <div className="w-full h-full rounded-[10px] border border-[#F1F1F1] bg-[#FAFAFA] overflow-hidden relative">
            ...
            >
              <img 
                src="/lovable-uploads/ba586654-8dbf-4816-982c-ba72b3fda697.png" 
      ...
      >
        <div className="w-full md:w-[415px] h-auto md:h-[340px] relative">
          <div className="w-full h-full rounded-[10px] border border-[#F1F1F1] bg-[#FAFAFA] overflow-hidden relative">
            ...
            >
              <Skeleton className="w-full h-[308px] bg-gray-200" />
            </div>
          </div>
        </div>
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-[40px] font-general font-semibold leading-tight mb-4">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center text-center divide-y md:divide-y-0 md:divide-x divide-[#EAECF0]">
          ...
          >
            <div className="font-general font-bold text-[48px] text-[#F97316] mb-2">1M+</div>
            <div className="font-general text-[18px] text-gray-600">Messages Delivered Daily</div>
          </div>
          ...
          >
            <div className="font-general font-bold text-[48px] text-[#F97316] mb-2">5000+</div>
            <div className="font-general text-[18px] text-gray-600">Business Customers</div>
          </div>
          ...
          >
            <div className="font-general font-bold text-[48px] text-[#F97316] mb-2">99.9%</div>
            <div className="font-general text-[18px] text-gray-600">Delivery Success Rate</div>
          </div>
        </div>
      </div>
    </section>
